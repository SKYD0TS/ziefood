<div class="modal fade" id="formInputMeja" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form method="post" action="meja">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="double" class="form-control" name="nomor_meja" id="nomor_meja">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="double" class="form-control" name="kapasitas" id="kapasitas">
            </div>
          </div>
